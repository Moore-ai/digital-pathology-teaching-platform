...
export function DropdownMenuLabel({
  ...
  inset,
  ...props
}: DropdownMenuLabelProps): ReactNode {
  return (
...
export function DropdownMenuSubTrigger({
  ...
  children,
  ...props
}: DropdownMenuSubTriggerProps): ReactNode {
  return (
...
export function DropdownMenuSubContent({
  ...
  className,
  ...props
}: DropdownMenuSubContentProps & Omit<MenuPrimitive.Popup.Props, keyof DropdownMenuSubContentProps>): ReactNode {
  return (
    <DropdownMenuContent
...
export function DropdownMenuRadioItem({
  ...
  inset,
  ...props
}: DropdownMenuRadioItemProps): ReactNode {
  return (
...
export function DropdownMenuSeparator({
  className,
  ...props
}: DropdownMenuSeparatorProps): ReactNode {
  return (
...
export function DropdownMenuShortcut({
  className,
  ...props
}: DropdownMenuShortcutProps): ReactNode {
  return (
    <span
